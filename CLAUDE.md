...
Issues live in GitHub Issues on Raild3x/ModulesOnRails (via the `gh` CLI);
...
Multi-context: `CONTEXT-MAP.md` at the root points to per-package
`CONTEXT.md` files under `lib/<package>/`. See `docs/agents/domain.md`.