...
| [Heap](https://raild3x.github.io/ModulesOnRails/api/Heap) | `Heap = "raild3x/heap@1.0.1"` | A generic min/max heap implementation in Luau. |
...
| [RemoteComponent](https://raild3x.github.io/ModulesOnRails/api/RemoteComponent) | `RemoteComponent = "raild3x/remotecomponent@0.1.2"` | A component extension to provide easy networking functionality. |
...
| [TableReplicator](https://raild3x.github.io/ModulesOnRails/api/ServerTableReplicator) | `TableReplicator = "raild3x/tablereplicator@0.2.3"` | A set of classes for replicating tables and their changes between server and client with minimal effort. |
